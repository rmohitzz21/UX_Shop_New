  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      try {
        ...
        // Load custom fields
        const existingFields = Array.isArray(p.custom_fields_parsed) ? p.custom_fields_parsed : [];
        existingFields.forEach(cf => addCustomField(cf.label || '', cf.value || ''));
    ...
    document.getElementById('edit-product-form').addEventListener('submit', serializeCustomFields, true);
  </script>
</body>
